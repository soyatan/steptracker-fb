    ...
    <LinearGradient
      ...
      <View style={styles.mockoption}>
        <Text style={styles.mockoptiontext}>
          Generated locations (do not approve location permission on emulator)
        </Text>

        <Text style={styles.mockoptiontext}>Initial Coordinates</Text>
        {!isValid ? (
          <Text style={styles.errortext}>Please Enter Valid Coordinates</Text>
        ) : null}
        <View
          style={{
            flexDirection: 'row',
